export const auctionHouseAbi = [
  ...
  },
  {
    ...
    inputs: [
      ...
      },
      {
        indexed: false,
        internalType: "uint256",
        name: "pointsPaidToCreators",
        type: "uint256",
      },
      {
        indexed: false,
        internalType: "uint256",
        name: "ethPaidToCreators",
        type: "uint256",
      },
    ],
    name: "AuctionSettled",
  ...
  {
    inputs: [
      { internalType: "uint256", name: "paymentAmountWei", type: "uint256" },
    ],
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: "contract IRevolutionPointsEmitter",
        name: "",
        type: "address",
      },
    ],
  ...
  },
  {
    ...
    outputs: [
      { internalType: "contract IRevolutionToken", name: "", type: "address" },
    ],
    stateMutability: "view",
    type: "function",
  },
  {
    inputs: [
      { internalType: "uint256", name: "_creatorRateBps", type: "uint256" },
    ],
  ...
  {
    inputs: [
      { internalType: "uint256", name: "_entropyRateBps", type: "uint256" },
    ],
  ...
  {
    inputs: [
      { internalType: "address", name: "_grantsAddress", type: "address" },
    ],
  ...
  {
    inputs: [
      { internalType: "uint256", name: "_grantsRateBps", type: "uint256" },
    ],
  ...
  {
    inputs: [
      { internalType: "uint256", name: "_minCreatorRateBps", type: "uint256" },
    ],
