...
export const auctions = onchainTable(
  ...
  (t) => ({
    ...
    saleType: t.text().notNull(),
    pieceId: t.text(),
    submissionSlug: t.text(),
    buyer: t.text(),
    recipient: t.text(),
    referral: t.text(),
  ...
  (table) => ({
    ...
    saleTypeIdx: index().on(table.saleType),
    submissionSlugIdx: index().on(table.submissionSlug),
    buyerIdx: index().on(table.buyer),
    recipientIdx: index().on(table.recipient),
    tokenLookupIdx: index().on(
      table.chainId,
      table.nftContractAddress,
      table.nftTokenId,
    ),
    saleContractTokenIdx: index().on(
      table.chainId,
      table.auctionContractAddress,
      table.nftContractAddress,
      table.nftTokenId,
    ),
